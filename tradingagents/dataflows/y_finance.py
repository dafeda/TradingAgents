...
def get_YFin_data_online(
    ...
    # past end_date so the requested range is actually inclusive.
    ...
    # turns into one clear unavailable signal.
    ...
    header = f"# Price data for {label} from {start_date} to {end_date}\n"
